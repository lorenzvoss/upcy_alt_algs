...
public class RecommendationAlgorithmInitHelper {
  ...
  public static IRecommendationAlgorithm InitializeRecommendationAlgorithm(
      MavenInvokerProject mavenInvokerProject, Path depGraphJsonFile, String graphAlgorithm)
    ...
    switch (graphAlgorithm.toLowerCase()) {
      case "dijkstra":
        throw new UnsupportedOperationException(
            "Recommendation Algorithm with dijkstra is not implemented yet.");
      ...
      case "gomory":
      case "gusfieldgomory":
        return new GusfieldGomoryHuCutTreeRecommendationAlgorithm(
            mavenInvokerProject, depGraphJsonFile);
      case "pushrelabel":
